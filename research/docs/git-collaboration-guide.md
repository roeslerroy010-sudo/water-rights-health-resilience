...
> 给 Blue Lifeline 队员的最小可用指南。不需要懂 Git 原理，照做就行。
> 有任何一步卡住，直接在群里问，不要硬试——Git 出错时乱试容易越弄越乱。
...
| 写一份文档交给团队（文献综述、术语表、脚本） | **建议用**，这样有版本记录 |
| 改工具的代码 | 需要 |
...
https://github.com/roeslerroy010-sudo/water-rights-health-resilience
...
去 https://github.com 注册，然后**把用户名发到群里**，队长会把你加为协作者。

你会收到一封邀请邮件，或者在 https://github.com/notifications 看到邀请，**点接受**。没接受之前你没有推送权限。
...
**Windows**：下载 https://git-scm.com/download/win ，一路默认下一步。装完在开始菜单找到「Git Bash」，之后所有命令都在 Git Bash 里敲。
...
| 橙旭 | 代码 | `research/js/`、`research/css/` |
...
- **GitHub Desktop**（推荐，最简单）：https://desktop.github.com
